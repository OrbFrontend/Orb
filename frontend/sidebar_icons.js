// Sidebar actions must be vector artwork rather than font glyphs: themes are
// free to change --font-ui, while control geometry needs to remain stable.
const icon = (paths) =>
...
// The one edit glyph the app uses. Exported as bare paths (24x24 viewBox) so
// callers outside the sidebar — the message toolbar, the static header buttons
// in index.html — draw the same symbol at their own size and stroke weight.
