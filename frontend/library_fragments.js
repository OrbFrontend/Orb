    ...
    .map((f) => {
      ...
      const userBadge =
        f.field_type === "feedback"
          ? ` <span class="frag-target-badge" style="font-size:9px;color:var(--accent);border:1px solid var(--accent);border-radius:4px;padding:0 4px;vertical-align:middle;">shown to you</span>`
          : "";
      return `
