...
def apply_tool_calls(
    ...
    refined, plot_direction, writing_direction, detected_repetitions, plot_summary, keywords = (
...
async def _agent_pass(
    ...
    refined_msg, plot_direction, writing_direction, detected_repetitions, plot_summary = (
    ...
    for name in tool_names:
        ...
        try:
            ...
            if parsed := parse_tool_calls(resp):
                ...
                if new_plot:       plot_direction        = new_plot
    ...
    yield {
        ...
        "result": (
            ...
            refined_msg, plot_direction, writing_direction,
